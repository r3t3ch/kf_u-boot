...
#define BQ27541_I2C_BUS	(0)			/* I2C Bus # of BQ27541 */
...
int bq27541_temperature(s16 *temp)
{
	...
	/* Convert to Celsius */
	*temp = (__le16_to_cpu(value) - 2731) / 10;
...
U_BOOT_CMD(
	...
	"bq27541_temperature - Return battery temperature in Celsius\n",
	NULL
);
