...
extern char const _binary_lowbattery_charging_gz_start[];
extern char const _binary_lowbattery_charging_gz_end[];

extern char const _binary_authfailed_gz_start[];
extern char const _binary_authfailed_gz_end[];
