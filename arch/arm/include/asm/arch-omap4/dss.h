...
/* LCD pol freq flags */
#define OMAP_DSS_LCD_IVS		1<<12
#define	OMAP_DSS_LCD_IHS		1<<13
#define OMAP_DSS_LCD_IPC		1<<14
#define OMAP_DSS_LCD_IEO		1<<15
#define OMAP_DSS_LCD_RF			1<<16
#define OMAP_DSS_LCD_ONOFF		1<<17
