...
#define CM_L3INIT_USB_OTG_SS_CLKCTRL		0x4A0093F0UL
#else
...
#if defined(CONFIG_DRA7XX)
#define USBOTGSS_IRQENABLE_SET_0	0x4888002c
#define USBOTGSS_IRQENABLE_SET_1	0x4888003c
#define USBOTGSS_SYSCONFIG		0x48880010
