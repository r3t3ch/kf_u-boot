...
#define CONFIG_DIAGNOSTIC_BOOTARGS "console=ttyO2,115200n8 mem=1G" \
            " init=/init root=/dev/mmcblk0p4 vram=5M omapfb.vram=0:5M androidboot.console=ttyO2"
#define CONFIG_DIAGNOSTIC_512M_BOOTARGS "console=ttyO2,115200n8 mem=512M" \
            " init=/init root=/dev/mmcblk0p4 vram=5M omapfb.vram=0:5M androidboot.console=ttyO2"

#define CONFIG_DIAGNOSTIC_BOOTCOMMAND "mmcinit 1;mmc 1 read 0x400 0x81000000 0x600000;bootm 0x81000000"
