...
#define CONFIG_LPDDR2_EMMC_DETECT 1
/* Bowser revisions */
...
#define CONFIG_BTMACADDR_TAG     1 /* enable btmacaddr */
#define CONFIG_QMFG_TAG          1 /* enable qmfg */
#define CONFIG_GYROCAL_TAG	 1 /* enable invcal */
...
#define C_MSK ( CFG_CMD_DHCP | CFG_CMD_NFS | CFG_CMD_NET | CFG_CMD_IMLS | \
		CFG_CMD_FLASH | CFG_CMD_LOADB | CFG_CMD_BDI | \
		CFG_CMD_AUTOSCRIPT | CFG_CMD_ECHO | CFG_CMD_IMI | \
		CFG_CMD_ITEST | CFG_CMD_LOADS | CFG_CMD_JFFS2 )
/* Config CMD*/
#define CONFIG_COMMANDS          ((CFG_CMD_I2C | CONFIG_CMD_DFL | \
		CFG_CMD_MMC | CFG_CMD_FAT) & ~(C_MSK))
...
/* LPDDR2_1G */
#define CONFIG_DIAGNOSTIC_BOOTARGS "console=ttyO2,115200n8 mem=448M@0x80000000 mem=512M@0xA0000000 " \
			"init=/init vram=32M omapfb.vram=0:16M androidboot.console=ttyO2 " \
			"root=/dev/mmcblk0p6 rw rootdelay=1"
/* Default 512M */
/*
#define CONFIG_DIAGNOSTIC_BOOTARGS "console=ttyO2,115200n8 mem=448M@0x80000000 " \
                        "init=/init vram=32M omapfb.vram=0:16M androidboot.console=ttyO2 " \
                        "root=/dev/mmcblk0p6 rw rootdelay=1"
*/
