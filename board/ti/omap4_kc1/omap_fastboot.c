...
#include "include/usb_debug_macros.h"
...
char *device_strings[DEVICE_STRING_MAX_INDEX+1];
...
static int do_usb_req_get_descriptor(void)
{
	...
	else
	{
		...
		else if (USB_DT_QUAL == (req.wValue >> 8)) {
...
#ifndef CONFIG_DISABLE_FASTBOOT_DMA
			/*
...
int fastboot_init(struct cmd_fastboot_interface *interface) 
{
	...
	device_strings[DEVICE_STRING_PRODUCT_INDEX]       = "Generic";
	...
	fastboot_board_init(interface, device_strings);
