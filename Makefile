...
omap4430otter2_config \
omap4430otter2_512m_config :    unconfig
	@./mkconfig -a omap4430otter2 arm omap4 omap4430otter2
	@if [ "$(findstring 512m, $@)" ] ; then \
		echo "#define CONFIG_OTTER" >> ./include/config.h ; \
	else \
		echo "#define CONFIG_OTTER2" >> ./include/config.h ; \
	fi;
